...
<section class="dashboard-card">
    <h2>Gestión de Funciones para Rol: {{rolesdsc}}</h2>
    
    <div class="info-section">
        <div class="info-row">
            <div class="info-label">Código de Rol:</div>
            <div class="info-value">
                <input class="info-input" type="text" value="{{rolescod}}" disabled readonly />
            </div>
        </div>
        <div class="info-row">
            <div class="info-label">Descripción:</div>
            <div class="info-value">
                <input class="info-input" type="text" value="{{rolesdsc}}" disabled readonly />
            </div>
        </div>
    </div>
    ...
    <div class="split-layout">
        <div class="split-column">
            <h3 class="section-title title-assigned">Funciones Asignadas</h3>
            <table class="styled-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{fndsc}} <br><small style="color: #6c757d;">({{fncod}})</small></td>
                        <td style="text-align: center;">
                            {{if ~showEdit}}
                            <form action="index.php?page=Mantenimientos_Roles_Formulario&mode={{~mode}}&id={{~rolescod}}" method="POST" onsubmit="return confirm('¿Está seguro que desea realizar esta acción?');">
        ...
        <div class="split-column">
            <h3 class="section-title title-available">Funciones Disponibles</h3>
            <table class="styled-table">
                <thead>
                    <tr>
                        <th>Función</th>
